# This file looks for new folders inside user_uploads and converts them to reel if they are not already converted
...
if __name__=="__main__":
     while True:
      print("Processing queue............")
          # we will check if the folder is already processed or not
      ...
      for folder in folders:
          if (folder not in done_folders):
              text_to_audio(folder)  # Generate the audio from desc.text 
              create_reel(folder)    # Convert the images and audio.mp3 inside the folder to a reel
              with open("done.txt","a") as f: # after processed, store it to done file
                  f.write(folder + "\n") 
